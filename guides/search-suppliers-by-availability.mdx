...
| `GET .../suppliers` | "Who exists (regardless of availability)?" | The supplier catalogue, filterable by service/skill/location. See [Suppliers](/resources/suppliers). |
...
[`GET /suppliers`](/resources/suppliers).
</Note>
