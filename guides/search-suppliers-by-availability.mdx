...
`POST /holds { intervals: [{ supplierId, startUtc, endUtc, locationId }] }`
works for a **single session**, with no package or slate involved, and you
then convert the hold into the booking. See
